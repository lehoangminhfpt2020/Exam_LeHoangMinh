...
using LeHoangMinh.Models;

namespace LeHoangMinh.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmployeeController : ControllerBase
    {
        private readonly EAP_Exam_LeHoangMinhContext _context;

        public EmployeeController(EAP_Exam_LeHoangMinhContext context)
        {
            _context = context;
        }
